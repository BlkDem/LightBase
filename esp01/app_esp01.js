	...
	function setRange()
	{
		...
		var _c2_to = parseInt(document.querySelector('#count2').value);
		var _c3_to = parseInt(document.querySelector('#count3').value);
		var _c4_to = parseInt(document.querySelector('#count4').value);
		(_c2_to > _c2)?document.querySelector('#caption_count2').innerHTML = ' ' + _c2 + ' to ' + _c2_to:document.querySelector('#caption_count2').innerHTML = ' <span class="text-danger">' + _c2 + ' to ' + _c2_to + '</span>';
		(_c3_to > _c3)?document.querySelector('#caption_count3').innerHTML = ' ' + _c3 + ' to ' + _c3_to:document.querySelector('#caption_count3').innerHTML = ' <span class="text-danger">' + _c3 + ' to ' + _c3_to + '</span>';
		(_c4_to > _c4)?document.querySelector('#caption_count4').innerHTML = ' ' + _c4 + ' to ' + _c4_to:document.querySelector('#caption_count4').innerHTML = ' <span class="text-danger">' + _c4 + ' to ' + _c4_to + '</span>';
		/*document.querySelector('#caption_count3').innerHTML = ' ' + _c3 + ' to ' + _c3_to;
		document.querySelector('#caption_count4').innerHTML = ' ' + _c4 + ' to ' + _c3_to;*/
